...
*********************************************************************/
(function(E,q){"function"===typeof define&&define.amd?define([],q):"object"===typeof exports?module.exports=q():q()})(this,function(){function E(a){if(null===t){for(var f=a.length,b=0,k=document.getElementById(F),g="<div class='slider2'>";b<f;)g+="<div class='slide'>"+a[b]+"</div>",b++;k.innerHTML=g+"</div>"}else t(a)}function q(a){return a.replace(/<b[^>]*>(.*?)<\/b>/gi,function(a,b){return b}).replace(/class="(?!(tco-hidden|tco-display|tco-ellipsis))+.*?"|data-query-source=".*?"|dir=".*?"|rel=".*?"/gi,"")}function G(a){a=a.getElementsByTagName("a");
...
// hashtags.
var configProfile = {
  "profile": {"screenName": 'pankajgupta20de'},
  "domId": 'feeds',
  "maxTweets": 5,
  "enableLinks": true, 
  "showUser": true,
